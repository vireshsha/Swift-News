...
func parseJson(results: [[String: Any]])  {
      results.forEach {child in
           ...
           do{
            ...
            if((dataDic?["thumbnail"] as? String) != nil && dataDic?["thumbnail"] as? String != "self" && dataDic?["thumbnail"] as? String != "default") {
                //print("imageString= \(String(describing: dataDic?["thumbnail"]))")
